...
namespace UAMS\Shortcode_UI\Shorcake_Bakery;

// Adjust defaults included with Shortcake Bakery
add_filter( 'shortcake_bakery_shortcode_classes', 'UAMS\Shortcode_UI\Shorcake_Bakery\filter_shortcodes' );
add_action( 'after_setup_theme', 'UAMS\Shortcode_UI\Shorcake_Bakery\remove_embed_button', 999 );
